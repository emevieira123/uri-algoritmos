...
percorrida e, em seguida, calcular quantos litros seriam necessários. Mostre o valor com 3 
...
namespace problema11
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            kmPercorrido = tempo * velocidade;
            qtdLitros = kmPercorrido / kmPorLitro;

            System.Console.WriteLine("{0:f3}", qtdLitros);
